 ...
  'use strict';
  ...
  return {
    ...
    eo: {
      all: 'Ĉio',
      contacts: 'Kontaktoj',
      noContacts: 'Vi ne havas kontaktojn',
      jan: 'Jan',
      feb: 'Feb',
      mar: 'Mar',
      apr: 'Apr',
      ...
      oldAppAlert: 'Ĉi tiu versio ne estas subtenita. Bonvole ĝisdatigu ĝin ' +
      'el Firefox Marketplace por ĝui pri novaj trajtoj.',
      selectCountryAlert: 'Bonvole elektu landon.',
      movilNumberValidationAlert: 'Ŝajnas, ke la telefonnumero\n' +
      '+{{prefix}} {{number}}\nne estas valida telefonnumero el ' +
      '{{country}}.\nĈu ĉiukaze daŭrigi?',
      registerErrorTooRecent: 'Estas tro malfrue por peti por nova ' +
      'aliĝkodo.\nKontrolu, ke vi ne jam ricevis la ' +
      'konfirmmesaĝon. Se tiel, atendu iomete aŭ klopodu aliĝi denove en {{minutes}} ' +
      'minutoj',
      registerErrorTooMany: 'Troaj malkorektaj klopodoj',
      registerErrorOldVersion: 'Malnova versio. Bonvole kontaktu la programistojn de OpenWapp',
      registerErrorStale: 'Aliĝkodo eksvalidiĝis. Vi sendu novan peton pri tio',
      registerErrorNoRoutes: 'Via portanto nun ne kapablas sendi SMS. ' +
      'Bonvole provu denove aŭ kontaktu la programistojn de OpenWapp',
      registerErrorGenericAlert: 'Oops, eraro. Mesaĝo: {{error}}',
      pinInvalidAlert: 'Nerekonata kodo. Bonvole klopodu denove.',
      screenNameAlert: 'Bonvole tajpu vian nomon.',
      inbox: 'Enirejo',
      noConversation: 'Neniu babilado.',
      selectContacts: 'Elektu kontakton en la kontaktliston de OpenWapp por ' +
      'ekbabili.',
      removeGroupConversation: 'Ĉu vi volas forlasi la grupon {{groupTitle}}' +
      ' kaj forigi la babiladon?',
      remove1to1Conversation: 'Ĉu vi volas forigi la babiladon' +
      ' kun {{who}}?',
      removeMessage: 'Ĉu vi volas forigi ĉi tiun mesaĝon?',
      today: 'Hodiaŭ',
      yesterday: 'Hieraŭ',
      before: 'Plimalnova',
      settings: 'Agordoj',
      profile: 'Profilo',
      profileExplanation: 'Ĉi tie vi povas agordi vian kontaktnomon, staton kaj ' +
      'kontaktbildon:',
      openWapp: 'OpenWapp',
      loading: 'Ŝargado…',
      loadingConversations: 'Ŝargado de babiladoj…',
      registerOpenWapp: 'Aliĝi al OpenWapp',
      registerIntroMessage: 'Registrado estas facile kaj rapide! Nur tajpu ' +
      'vian telefonnumeron.',
      countryDetectedOnLogin: 'Via numero devenas el {{country}}. ' +
      'Ŝanĝu ĝin ĉu ĝi ne estas korekta',
      countryNotDetectedOnLogin: 'Bonvole elektu vian landon sube',
      multipleSimCards: 'Via telefono havas plurajn SIM-kartojn. Bonvole elektu ' +
      'tiun, kiun vi volas uzi sube',
      country: 'Lando',
      yourNumberPlaceHolder: 'Telefonnumero',
      nextButton: 'Sekva',
      backButton: 'Reen',
      reEnterPhone: 'Registri alian numeron',
      goToValidateButton: 'Mi jam havas la kodon!',
      smsValMessage: 'Dankon, nun ni klopodas validigi vian numeron:',
      codePlaceholder: 'Kodo',
      sendingValCode: 'Validigado de numero…',
      loginEditIncorrect: 'Presi por ŝanĝi la numeron, ĉu ĝi ne estas korekta.',
      loginNumberOk: 'Presu Bone se via numero estas korekta.',
      acceptButton: 'Bone',
      name: 'Via nomo',
      settingsGeneral: 'Ĝenerala',
      settingsAbout: 'Pri',
      settingsVersion: 'Versio',
      logout: 'Elsaluti',
      validateCode: 'Bonvole tajpu la kodon, kiun vi ricevis ' +
      'per SMS ĉe',
      validateCodeProgress: 'Kontrolado de kodo…',
      validateCodeCall: 'Voki min',
      settingAccount: 'Agordado de via konto…',
      pictureDescription: 'Elektu bildon kiel via kontaktbildo',
      screenNamePlaceHolder: 'Via nomo',
      screenNameDescription: 'Tio aperos kiel via kontaktnomo',
      statusPlaceHolder: 'Mi emas…',
      statusDescription: 'Tio aperos kiel via kontaktstato',
      doneButton: 'Farite',
      pending: 'pritraktota',
      sent: 'sendita',
      unsent: 'nesendita',
      defaultImageCaption: 'Bildo',
      received: 'ricevita',
      composeImageCaptionPlaceholder: 'Aldoni apudskribon',
      sendButton: 'Sendi',
      loadImageError: 'La bildo neŝargeblas nune.\n Bonvole ' +
      'klopodu denove poste.',
      sendingImage: 'Sendado',
      audioMessageSent: 'Sono sendita',
      audioMessageReceived: 'Sono ricevita',
      loadAudioError: 'La dosiero neŝargeblas nune.\n Bonvole ' +
      'klopodu denove poste.',
      sendLocation: 'Sendi lokadon',
      loadLocationError: 'La lokado neŝargeblas nune.\n Bonvole ' +
      'klopodu denove poste.',
      retrievingLocation: 'Obtenado de lokado…',
      cancelButton: 'Nuligi',
      currentLocation: 'Mia aktuala lokado',
      logoutAlertText: 'Uzu ĉi tiun opcion nur kiam vi volas vakigi OpenWapp ' +
      'en ĉi tiu aparato por ensaluti en OpenWapp per malsama aparato. ' +
      'Por nekonektiĝi, simple malŝalti OpenWapp kaj ' +
      'ĝi aŭtomate nekonektiĝas.',
      savePicture: 'Konservi',
      sdCardUnavailable: 'Memorkarto nedisponeblas.',
      pictureSavePrompt: 'Ĉu vi volas konservi ĉi tiun bildon en la Bildaro?',
      pictureSaveInfo: 'Konservita',
      pictureSaveError: 'Eraro okazis dum konservado de la bildo.',
      migrationHeader: 'Ĝisdatigo de OpenWapp',
      migrationBody: 'OpenWapp estas ĝisdatiganta al nova versio.',
      migrationPleaseWait: 'Bonvole atendu',
      conversationLastSeen: 'Laste:',
      conversationIsOnline: 'Konektite',
      loadingParticipants: 'Ŝargado de kontaktoj…',
      invite: 'Inviti al WhatsApp',
      tellAFriendText: 'Kontrolu WhatsApp Messenger por Android, iPhone, ' +
      'Nokia, BlackBerry, Windows Phone kaj Firefox OS nun! Elŝutu ĝin ' +
      'hodiaŭ ĉe http://whatsapp.com/dl/',
      emojiListTitle: 'Elektu sendendan emoji',
      contactProfile: 'Kontaktoj de profilo',
      newGroup: 'Nova grupo',
      groupProfile: 'Informoj pri grupo',
      leaveGroup: 'Forlasi grupon',
      groupPictureDescription: 'Elektu bildon por la grupo',
      subjectPlaceHolder: 'Ĉi tiu grupo temas pri…',
      subjectDescription: 'Resumi pri kio temas ĉi tiu grupo',
      participants: 'Partoprenantoj',
      unknownParticipant: 'Nekonata partoprenanto',
      participantsDescription: 'Elektu la partoprenantojn al ĉi tiu grupo',
      addParticipant: 'Aldoni partoprenanton',
      removeParticipant: 'Forigi partoprenanton',
      image: 'Bildo',
      video: 'Filmeto',
      audio: 'Sono',
      you: 'Vi',
      notificationSubjectChanged: '{{who}} ŝanĝis la temon de la grupo ' +
                                       'al:\n{{subject}}',
      notificationSubjectChangedByYou: 'Vi ŝanĝis la temon de la grupo ' +
                                       'al:\n{{subject}}',
      notificationGroupParticipantAdded: '{{who}} aliĝis al grupo',
      notificationGroupParticipantRemoved: '{{who}} forlasis la grupon',
      notificationGroupPictureUpdated: '{{who}} ŝanĝis la grupbildon',
      notificationGroupPictureUpdatedByYou: 'Vi ŝanĝis la grupbildon',
      notificationGroupPictureRemoved: '{{who}} forigis la grupbildon',
      notificationGroupPictureRemovedByYou: 'Vi forigis la grupbildon',
      notificationReportTitle: 'Vi havas {{count}} nova(j)n mesaĝo(j)n.',
      notificationReportBody: 'El {{count}} babilado(j).',
      inAppNotification: '{{title}}: {{body}}',
      wakeUpTime: 'Kontrolu por novaj mesaĝoj…',
      wakeUpDescription: 'Tempperiodo por kontroli por novaj mesaĝoj: ju pli ' +
                         'la periodo estas mallonga, des pli la baterio plikonsumas.',
      eachMinute: 'je 1 minuto',
      each5Minutes: 'je 5 minutoj',
      each10Minutes: 'je 10 minutoj',
      each20Minutes: 'je 20 minutoj',
      each30Minutes: 'je 30 minutoj',
      eachHour: 'je 1 horo',
      disabled: 'Neniam',
      termsOfUse: 'Termoj kaj kondiĉoj',
      fileTooLargeToBeSent: 'La dosiero tro pezas. La limigo por sendi ' +
                            'dosierojn estas 10 MB.',
      errorAddingParticipant: 'Ĉi tiu kontakto nealdoneblas al ĉi tiu grupo',
      genericConnectionProblem: 'Neatendita problemo okazis. Ĉu vi ' +
            'certas, ke vi estas konektite? Klopodu fermi kaj malfermi OpenWapp denove. Se tia ' +
            'agado daŭras, klopodu denove poste.',
      participatingInTooMuchGroups: 'Vi estas partoprenanta al troaj grupoj.' +
      'La limo estas 50. Vi forlasu unu grupon tiel, ke vi povas aliĝi al nova.',
      accountExpired: 'Via konto eksvalidiĝis. Ĉu vi volas ĝisdatigi ' +
                         'vian konton nun?',
      accountExpiration: 'Dato de eksvalidiĝo',
      upgradeNow: 'Ĝisdatigi nun',
      notSquarePicture: 'La elektita bildo ne estas kvadrata. ' +
      'Tiel plenumaj strioj aperos ĉirkaŭe. Se vi volas ripari tion, iru al ' +
      'Bildaro kaj redakti kaj stuci la bildon per ekranformato 1:1.',
      noSimForThisNumber: 'Neniu SIM-karto estas trovata por ĉi tiu numbero.',
      chooseNetwork: 'Bonvole elektu vian portanton sube',
      sameNumberMultiplePhonesWarning: 'Samtempa uzado de la sama ' +
      'telefonnumero en malsamaj aparatoj kaŭzas neatenditajn erarojn.',
      carrier: 'Portanto',
      simCard: 'SIM-karto'
    },
    es: {
    ...
    it: {
      ...
      oldAppAlert: 'Questa versione non è supportata. Aggiornala per favore ' +
      'dal Firefox Marketplace per ricevere nuove funzionalità.',
      selectCountryAlert: 'Per favore seleziona una nazione.',
      movilNumberValidationAlert: 'Il numero del cellulare:\n' +
      '+{{prefix}} {{number}}\nnon sembra essere un numero valido di ' +
      ...
      'codice. Se così fosse attendere un altro po\' oppure riprovare fra  {{minutes}} ' +
      'minuti',
      registerErrorTooMany: 'Troppi codici errati inseriti',
      registerErrorOldVersion: 'Versione obsoleta, per favore contatta gli sviluppatori di OpenWapp',
      registerErrorStale: 'Codice registrazione scaduto. Mandare una nuova richiesta per avere ' +
      'un nuovo codice.',
      registerErrorNoRoutes: 'OpenWapp non riesce a connettersi al tuo operatore. ' +
      'Per favore riprova oppure contatta gli sviluppatori',
      registerErrorGenericAlert: 'Oops, errore. Messaggio={{error}}',
      pinInvalidAlert: 'PIN non riconosciuto. Per favore riprova.',
      screenNameAlert: 'Per favore inserisci il tuo nome.',
      inbox: 'In entrata',
      ...
      pictureSavePrompt: 'Vuoi salvare questa immagine nella galleria?',
      ...
      migrationPleaseWait: 'Per favore attendi',
      ...
      emojiListTitle: 'Seegli un\'emoji da inviare',
      ...
      subjectDescription: 'Descrivi brevemente di cosa tratta questo gruppo',
      participants: 'Membri',
      ...
      wakeUpDescription: 'Intervallo di tempo nel quale OpenWapp controlla nuovi messaggi: meno tempo ' +
      ...
      'sicuro di essere connesso? Prova a chiudere e aprire nuovamente OpenWapp. Se il ' +
      'problema persiste, riprova più tardi.',
      participatingInTooMuchGroups: 'Stai partecipando a troppi gruppi. ' +
      ...
      notSquarePicture: 'L\'immagine selezionata non è quadrata. Questo aggiungerà all\'immagine ' +
      'un bordo riempitivo ai lati. Se vuoi risolvere il problema, vai nella ' +
      'Galleria ed edita la foto, usando 1:1 come scala.',
      noSimForThisNumber: 'Nessuna SIM individuata per questo numero.',
      chooseNetwork: 'Per favore seleziona il tuo operatore qui sotto',
      sameNumberMultiplePhonesWarning: 'L\'utilizzo simultaneo dello stesso ' +
      'numero su differenti dispositivi può causare problemi.',
      carrier: 'Operatore',
      simCard: 'SIM',
      simRequired: 'È richiesta una SIM. Senza una SIM, ' +
      'l\'applicazione potrebbe non funzionare.',
      multiSIMdetectedWarn: 'Individuate 2 SIM. ' +
      'OpenWapp utilizzerà la prima SIM.'
    },
    nl: {
      all: 'Alle',
      contacts: 'Contacten',
